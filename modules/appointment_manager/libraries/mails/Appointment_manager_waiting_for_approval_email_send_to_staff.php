...
class Appointment_manager_waiting_for_approval_email_send_to_staff extends App_mail_template
{
    protected $for = 'staff';
    ...
    public $slug = 'appointment-manager-appointment-wait-for-approval-to-staff';
