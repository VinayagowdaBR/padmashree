...
class Appointment_manager_upcoming_email_send_to_client extends App_mail_template
{
    ...
    public $slug = 'appointment-manager-appointment-status-upcoming-to-client';
