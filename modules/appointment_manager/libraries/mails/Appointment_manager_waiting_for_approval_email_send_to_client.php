...
class Appointment_manager_waiting_for_approval_email_send_to_client extends App_mail_template
{
    ...
    public $slug = 'appointment-manager-appointment-wait-for-approval-to-client';
