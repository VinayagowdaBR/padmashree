...
function calculate_total() {
  ...
  var calculated_tax,
    ...
    discount_percent = discount_area.find('input[name="discount_percent"]').val(),
    discount_fixed = discount_area.find('input[name="discount_total"]').val(),
    discount_total_type = discount_area.find(".discount-total-type.selected"),
  ...
  // LOGIC FIX: Determine Discount Mode based on Dropdown Selection
  var is_percent_discount = discount_total_type.hasClass("discount-type-percent");
  var is_fixed_discount = discount_total_type.hasClass("discount-type-fixed");

  // Calculate Discount
  if (is_fixed_discount) {
    total_discount_calculated = parseFloat(discount_fixed) || 0;
  } else if (is_percent_discount && parseFloat(discount_percent) > 0) {
    // Percentage
  ...
  if (!is_fixed_discount && parseFloat(discount_percent) > 0) {
    discount_area.find('input[name="discount_total"]').val(
