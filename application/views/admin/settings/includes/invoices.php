...
<div class="form-group">
 ...
 <div class="radio radio-primary radio-inline">
    <input type="radio" name="settings[invoice_number_format]" value="5" id="yymmdd_format"
        <?= get_option('invoice_number_format') == '5' ? 'checked' : '' ?>>
    <label for="yymmdd_format">YYMMDD001 <small>(e.g. <?= date('ymd') . '001' ?>)</small></label>
</div>
